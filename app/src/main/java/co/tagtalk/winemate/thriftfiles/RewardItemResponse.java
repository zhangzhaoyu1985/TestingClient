            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rewardItemList = new ArrayList<RewardSingleItem>(_list112.size);
                RewardSingleItem _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = new RewardSingleItem();
                  _elem113.read(iprot);
                  struct.rewardItemList.add(_elem113);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RewardItemResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.rewardItemList != null) {
        oprot.writeFieldBegin(REWARD_ITEM_LIST_FIELD_DESC);
        {
          ...
          for (RewardSingleItem _iter115 : struct.rewardItemList)
          {
      ...
      if (struct.isSetRewardItemList()) {
        {
          ...
          for (RewardSingleItem _iter116 : struct.rewardItemList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.rewardItemList = new ArrayList<RewardSingleItem>(_list117.size);
          RewardSingleItem _elem118;
          for (int _i119 = 0; _i119 < _list117.size; ++_i119)
          {
            _elem118 = new RewardSingleItem();
            _elem118.read(iprot);
            struct.rewardItemList.add(_elem118);
          }
        }
        struct.setRewardItemListIsSet(true);
      }
