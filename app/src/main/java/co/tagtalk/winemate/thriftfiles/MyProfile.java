...
public class MyProfile implements org.apache.thrift.TBase<MyProfile, MyProfile._Fields>, java.io.Serializable, Cloneable, Comparable<MyProfile> {
  ...
  private static final org.apache.thrift.protocol.TField WISHLIST_NUMBER_FIELD_DESC = new org.apache.thrift.protocol.TField("wishlistNumber", org.apache.thrift.protocol.TType.I32, (short)8);
  ...
  public int wishlistNumber; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    WISHLIST_NUMBER((short)8, "wishlistNumber");
  ...
  private static final int __WISHLISTNUMBER_ISSET_ID = 6;
  ...
  static {
    ...
    tmpMap.put(_Fields.HIDE_PROFILE_TO_STRANGER, new org.apache.thrift.meta_data.FieldMetaData("hideProfileToStranger", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.WISHLIST_NUMBER, new org.apache.thrift.meta_data.FieldMetaData("wishlistNumber", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public MyProfile(MyProfile other) {
    ...
    this.wishlistNumber = other.wishlistNumber;
  }
  ...
  public MyProfile setWishlistNumber(int wishlistNumber) {
    this.wishlistNumber = wishlistNumber;
    setWishlistNumberIsSet(true);
    return this;
  }

  public void unsetWishlistNumber() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __WISHLISTNUMBER_ISSET_ID);
  }

  /** Returns true if field wishlistNumber is set (has been assigned a value) and false otherwise */
  public boolean isSetWishlistNumber() {
    return EncodingUtils.testBit(__isset_bitfield, __WISHLISTNUMBER_ISSET_ID);
  }

  public void setWishlistNumberIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __WISHLISTNUMBER_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case WISHLIST_NUMBER:
      if (value == null) {
        unsetWishlistNumber();
      } else {
        setWishlistNumber((Integer)value);
      }
      break;
  ...
  public boolean equals(MyProfile that) {
    ...
    boolean this_present_wishlistNumber = true;
    boolean that_present_wishlistNumber = true;
    if (this_present_wishlistNumber || that_present_wishlistNumber) {
      if (!(this_present_wishlistNumber && that_present_wishlistNumber))
        return false;
      if (this.wishlistNumber != that.wishlistNumber)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_wishlistNumber = true;
    list.add(present_wishlistNumber);
    if (present_wishlistNumber)
      list.add(wishlistNumber);
  ...
  public int compareTo(MyProfile other) {
    ...
    lastComparison = Boolean.valueOf(isSetWishlistNumber()).compareTo(other.isSetWishlistNumber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWishlistNumber()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.wishlistNumber, other.wishlistNumber);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("wishlistNumber:");
    sb.append(this.wishlistNumber);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class MyProfileStandardScheme extends StandardScheme<MyProfile> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, MyProfile struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // WISHLIST_NUMBER
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.wishlistNumber = iprot.readI32();
              struct.setWishlistNumberIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MyProfile struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(WISHLIST_NUMBER_FIELD_DESC);
      oprot.writeI32(struct.wishlistNumber);
      oprot.writeFieldEnd();
