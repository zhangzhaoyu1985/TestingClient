...
public class Configs {
    ...
    public static final String SERVER_ADDRESS = "api.tagtalk.co";       // currently 50.18.207.106
    public static final String SERVER_ADDRESS_CN = "apicn.tagtalk.co";  // currently 54.223.152.54
